...
import uploadPricingImage from "../actions/upload-image";
...
interface UploadPricingImageModalProps {
  open: boolean;
  handleClose: () => void;
  pricingId: number;
}
...
export default function FileUploadModal({
  ...
  async function action() {
    ...
    const response = await uploadPricingImage(formData, pricingId);
